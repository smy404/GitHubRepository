...
public class WrapRecyclerView extends RecyclerView {
     ...
     * 给条目设置点击和长按事件
     *********************/
    public WrapRecyclerAdapter.OnItemClickListener mItemClickListener;
    public WrapRecyclerAdapter.OnLongClickListener mLongClickListener;

    public void setOnItemClickListener(WrapRecyclerAdapter.OnItemClickListener itemClickListener) {
    ...
    public void setOnLongClickListener(WrapRecyclerAdapter.OnLongClickListener longClickListener) {
